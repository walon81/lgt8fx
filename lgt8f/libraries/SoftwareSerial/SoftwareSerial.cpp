 ...
 */
__attribute__((always_inline)) inline void SoftwareSerial::_delay_loop_2(uint16_t __count)
{
	__asm__ volatile (
		"1: sbiw %0,1" "\n\t"
...
/* static */ 
__attribute__((always_inline)) inline void SoftwareSerial::tunedDelay(uint16_t delay) { 
  _delay_loop_2(delay);
}
